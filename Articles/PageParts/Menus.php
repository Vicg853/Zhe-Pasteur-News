		...
		<div id="ArticlesChoisesInMenu">
			<?php
		      ...
		      echo "<div id='ArticleChoisesLinkDIV'>
					    <a id='ArticlesChoisesLinkImage' href='".$row['PresentationImage']."' style='background-image: url(".$row['PresentationImage'].");background-repeat: no-repeat;background-size: cover;'></a>
                        <a id='ArticleChoisesLinkText' href='".$row['Link']."'>".$row['Name']."</a>
					</div>";
				}
				?>
		</div>
		...
		<div id="ArticlesChoisesInMenu">
				...
				while ($row = $GetItems->fetch())
				{
			      	...
			      	"<div id='ArticleChoisesLinkDIV'>
						    <a id='ArticlesChoisesLinkImage' href='".$row['Link']."' style='background-image: url(".$row['PresentationImage'].");background-repeat: no-repeat;background-size: cover;'></a>
	                        <a id='ArticleChoisesLinkText' href='".$row['Link']."'>".$row['Name']."</a>
						</div>";
				}
				?>
